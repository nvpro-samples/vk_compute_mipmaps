...
static uint32_t quadflex_dispatch(VkCommandBuffer          cmdBuf,
...
NVPRO_PYRAMID_ADD_FAST_DISPATCHER(quadflex, quadflex_dispatch<4>)
NVPRO_PYRAMID_ADD_FAST_DISPATCHER(quadflexmin1, quadflex_dispatch<2>)
