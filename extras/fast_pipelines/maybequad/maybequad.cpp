...
static uint32_t maybequad_dispatch(VkCommandBuffer          cmdBuf,
...
NVPRO_PYRAMID_ADD_FAST_DISPATCHER(maybequad, maybequad_dispatch<4>)
NVPRO_PYRAMID_ADD_FAST_DISPATCHER(maybequadmin1, maybequad_dispatch<2>)
